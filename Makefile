...
ACLOCAL = ${SHELL} /root/v9/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /root/v9/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/v9/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/v9/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /root/v9/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/v9
abs_srcdir = /root/v9
abs_top_builddir = /root/v9
abs_top_srcdir = /root/v9
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/v9/build-aux/install-sh
