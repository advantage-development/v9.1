...
GITHUB_REPO='Advantage-official/advantagecoin-core'
# Binary base name.
...
DAEMON_DOWNLOAD () {
  ...
  then
    ...
    wget -4 -qo- "$( wget -4 -qO- -o-  https://api.github.com/repos/Advantage-official/advantagecoin-core/releases/latest \
