...
* License: MIT
* Site: [https://bitcredittalk.org/index.php?topic=15276.0](https://bitcredittalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original bitcredit logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/bitcredit.icns, src/qt/res/src/bitcredit.svg,
