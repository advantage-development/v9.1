...
- [Building Advantage](#building-advantagecoin)
...
./bin/gbuild --commit advantagecoin=${COMMIT} --url advantagecoin=${URL} ../Advantage/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit advantagecoin=${COMMIT} --url advantagecoin=${URL} ../Advantage/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit advantagecoin=${COMMIT} --url advantagecoin=${URL} ../Advantage/contrib/gitian-descriptors/gitian-osx.yml
```
